...
echo -e 'peptide\tdomain\tphylum\tclass\torder\tfamily\tgenus\tspecies\tint1\tint2\tint3\tint4\n'\
...
'ISSVERYNOTREALE\tbacteria\tfirmicutes\tclostridia\tclostridiales\tclostridiaceae\t\t\t1000\t3000\t0\t0'> test_multiple.tab