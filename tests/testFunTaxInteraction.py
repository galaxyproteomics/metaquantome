...
#     #     ft_df = expand(mode='taxfn', samps=tu.TTEST_SINFO, int_file=int, func_colname='cog', func_file=func,
...
#         ft_df = expand('taxfn', samps=tu.TTEST_SINFO, int_file=int, func_colname='cog', func_file=func, tax_file=tax,
#                                  ontology='cog', tax_colname='lca')
