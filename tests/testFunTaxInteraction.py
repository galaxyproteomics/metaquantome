...
class TestFunctionTaxInteraction(unittest.TestCase):
    def testReadAndDE(self):
        ...
        ft_df = runner(mode='taxfn', sinfo=tu.TTEST_SINFO, int_file=int, func_colname='cog',
                       func_file=func, tax_file=tax, ontology='cog', tax_colname='lca', test=True, parametric=True)
    ...
    def testSumming(self):
        ...
        ft_df = runner('taxfn', sinfo=tu.TTEST_SINFO, int_file=int, func_colname='cog',
                       func_file=func, tax_file=tax, ontology='cog', tax_colname='lca', test=True, parametric=True)
