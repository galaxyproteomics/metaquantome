...
class TestTaxonomyAnalysis(unittest.TestCase):
    ...
    def testWrite(self):
        ...
        runner(mode='tax', sinfo='{"samp1": ["int"]}', int_file=int, tax_file=tax, tax_colname='lca',
               outfile=out)
    ...
    def testMultCols(self):
        ...
        tax_df = runner('tax', sinfo='{"s1": ["int1", "int2", "int3"]}', int_file=int, tax_file=tax,
                        tax_colname='lca')
    ...
    def testTaxTTests(self):
        ...
        tax_df = runner('tax', sinfo=TTEST_SINFO, int_file=int, tax_file=tax,
